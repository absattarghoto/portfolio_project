        ...
        <form className="max-w-3xl mx-auto space-y-6">
          ...
          <div>
            <textarea
              ...
              name="message"
              rows={4}
              className="block p-2.5 w-full text-sm text-[#4C4C4C] bg-[#17171700] rounded-lg border border-[#4C4C4C]  focus:border-[#27ae60]"
          ...
          <button
              type="button"
              className="px-8 py-3.5 w-[143px] bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
            >
              Submit
            </button>
          </div>
