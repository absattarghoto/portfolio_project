          ...
          <form className="space-y-4 md:space-y-6">
            ...
            <div>
              <textarea
                ...
                name="message"
                rows={4}
                className="block p-2.5 w-full text-sm text-[#4C4C4C] bg-transparent rounded-lg border border-[#4C4C4C] appearance-none focus:outline-none focus:ring-0 focus:border-[#27ae60] peer"
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="px-8 py-3.5 bg-emerald-500 w-full sm:w-[143px] text-white rounded-lg font-medium hover:bg-emerald-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
              >
                Submit
              </button>
            </div>
